...
| P2-004 | Realized P&L initially omitted the direct cash-flow impact of the locked 2-point entry slippage, overstating realized profitability and win rate. | Corrected Phase 2 implementation and reran the baseline. Corrected result is 77.36% conditional win rate and ₹1,702.98 mean net P&L per gated trade. |
